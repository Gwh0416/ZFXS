...
class TestController {
    ...
    @PostMapping("/speechtest")
    public R<String> speech(MultipartFile file) throws IOException {
...
//            if(jsonObject.getString("result")){
//
//            }
...
//
//
//        String url = "http://127.0.0.1:8999/voice/"+inputStr;
////        log.info(inputStr);
////        log.info(url);
//        InputStream is = null;
...
//
//        String urls = "http://127.0.0.1:8988/model/"+KindStr;
////        log.info(inputStr);
////        log.info(urls);
//        is = null;
//        br = null;
